...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<base href="<%=basePath%>" />
		<title>217论坛--<jsp:getProperty property="topicTitle" name="topic" /></title>
		...
		<meta name="keywords" content="论坛,BBS,217论坛,刘明高,修改个人资料" />
		<meta name="description" content="217论坛  我们交流的平台" />
		<meta name="author" content="刘明高" />
		<meta name="copyright" content="2017 山西师范大学数学与计算机科学学院" />
	...
	<body>
		<div id="main">
			...
			<%
				List<Reply> res = (ArrayList<Reply>) request
